const C='skmcis-study-v4-5-advanced-reasoning-hard-cache-bypass-20260807';
const SHELL=["./","./index.html","./styles.css?v=4.3.1","./app-v4-5.js","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
...
self.addEventListener('fetch',e=>{
 ...
 const networkFirst =
   ...
   path.endsWith('/app.js') || path.endsWith('/app-v4-5.js') ||
