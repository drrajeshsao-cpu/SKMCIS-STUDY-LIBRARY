const C='skmcis-study-v5-1-sciatica-final-hard-cache-bypass-20260807';
const SHELL=["./","./index.html","./styles.css?v=4.3.1","./app-v5-1.js","./manifest.webmanifest","./icon-192.png","./icon-512.png"];
...
self.addEventListener('fetch',e=>{
 ...
 const networkFirst =
   ...
   path.endsWith('/app.js') || path.endsWith('/app-v5-1.js') ||
   ...
   path.endsWith('/data/clinical-master-sciatica-final-v1.json');
 if(networkFirst){
