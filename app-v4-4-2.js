...
async function load(){
 ...
 try{
   ...
   const pb=document.querySelector('.prescriberBand small');if(pb)pb.textContent='Prescriber data loaded for '+Object.keys(PRESCRIBER).filter(id=>CHAPTERS[id]).length+' core chapters • clinician-reviewed draft';
